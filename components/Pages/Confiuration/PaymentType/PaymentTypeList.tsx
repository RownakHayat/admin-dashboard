...
import { useChangeOrganizerStatusMutation, useGetOrganizerPaginationQuery } from '@/store/features/configuration/organizer';
import { createColumnHelper } from '@tanstack/react-table';
import { useMemo } from 'react';
import PaymentTypeForm from './form/paymentTypeForm';
...
const PaymentTypeList = () => {
    ...
    const { data: listQuery, refetch, isLoading } = useGetOrganizerPaginationQuery(paramsValue)


    const [ChangeStatus] = useChangeOrganizerStatusMutation()
    ...
    return (
        <div>
            <div className='w-full'>
                <PaymentTypeForm refetch={refetch} />
                <div>
