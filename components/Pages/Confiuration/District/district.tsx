...
import { useChangeDistrictStatusMutation, useGetDistrictPaginationQuery } from '@/store/features/configuration/district';
...
const DistrictComponent = () => {
    ...
    const { data: listQuery, refetch, isLoading } = useGetDistrictPaginationQuery(paramsValue)
    const [ChangeStatus] = useChangeDistrictStatusMutation()
    ...
    const columns: any = useMemo(() => [
        ...
        columnHelper.accessor((tableField) => tableField?.division?.name, {
            id: "division",
            header: "Division",
        }),
            ...
            cell: ({ row }: any) => {
                return (
                    <div className=" flex justify-left space-x-3">
                        <CheckPermission subMod={'district'} permission={'district_status'}>
                            <SwitchButton
                        ...
                        <CheckPermission subMod={'district'} permission={'district_edit'}>
    ...
    return (
        <div>
            <div className='w-full'>
                <CheckPermission subMod={'district'} permission={'district_add'}>
                    <DistrictForm refetch={refetch} />
                </CheckPermission>
                <div>
                    <Search name="type_name" />
                </div>
                <CheckPermission subMod={'district'} permission={'district_list'}>
