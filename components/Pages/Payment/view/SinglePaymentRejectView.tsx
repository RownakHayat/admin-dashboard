...
const SinglePaymentRejectView: React.FC<PaymentValueProps> = ({
  open,
  onClose,
  singlePaymentValues,
}) => {
        ...
        <DialogContent className="max-w-lg w-full h-auto p-0 bg-[#e9e9ea] rounded-lg">
          ...
          >
            ...
            <div className="grid grid-cols-12 gap-4 md:gap-6 my-5">
              ...
              {/* Mobile No */}
              <div className="col-span-12 items-start sm:items-center gap-2 text-justify text-wrap">
                <span className="text-sm font-semibold">Remarks:</span>
                <span className="text-sm">
                  {singlePaymentValues?.payment?.remarks}
                </span>
              </div>
...
export default SinglePaymentRejectView;
