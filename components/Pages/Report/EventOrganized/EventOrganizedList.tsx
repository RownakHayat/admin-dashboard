...
import { useGetEventOrganizedReportByIdQuery } from '@/store/features/report/eventOrganized';
...
const EventOrganizedList = () => {
  ...
  } = useGetEventOrganizedReportByIdQuery(id, {
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-12">
            <div className="bg-headerbg p-5 mb-3 flex justify-between">
              <p className="text-2xl">Event Organized</p>
              {
                print && <Image
        ...
        <div ref={componentRef}>
          {
            id != null || id != undefined ? <>
              <ReportTable eventReportData={eventReportData} setprint={setprint}/>
            </> : <></>
          }
        </div>
      </div>
...
export default EventOrganizedList
