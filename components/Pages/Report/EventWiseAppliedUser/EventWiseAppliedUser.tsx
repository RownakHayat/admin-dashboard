...
import { useGetEventWiseAppliedUserQuery } from '@/store/features/report/eventWiseAppliedUser';
import { zodResolver } from '@hookform/resolvers/zod';
import { useState } from 'react';
import { SubmitHandler, useForm } from 'react-hook-form';
import { z } from 'zod';
import EventWiseAppliedUserReport from './Components/EventWiseAppliedUserReport';
...
const EventWiseAppliedUserComponent = () => {
  ...
  return (
    <>
      <div className='mx-4'>
          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12">
              <div className="bg-headerbg p-5 mb-3 flex justify-between">
                <p className="text-2xl">Event Wise Applied User Report</p>
              </div>
            </div>
        ...
        <div>
          {
            !isInitialRender && <EventWiseAppliedUserReport eventWiseAppliedUserList={eventWiseAppliedUserList} setprint={setprint} />
          }
        </div>
      </div>
    </>
...
export default EventWiseAppliedUserComponent