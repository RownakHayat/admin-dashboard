...
import { useGetFairSaleReportQuery } from '@/store/features/report/fairSaleReport'
...
const FairSaleReportList = () => {
  ...
  return (
    <div>
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-12">
          <div className="bg-headerbg p-5 mb-3 flex justify-between">
            <p className="text-2xl">Fair Sale Report</p>
          </div>
        </div>
      ...
      <div >
        {
          !isInitialRender && <ReportTable fairSaleReportData={fairSaleReportData}  />
        }
      </div>
    </div>
  )
...
export default FairSaleReportList
