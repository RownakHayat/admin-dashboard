...
const NotificationSelectEvent = ({ singleParticipateValues }: any) => {
  ...
  return (
    <>
      ...
      <div className=" p-6 m-6 mt-12 bg-[#fff] rounded-lg">
        <div className="xs:col-span-12 sm:col-span-12 2 text-sm">
          <div>
            <p className="text-[18px] font-bold text-center pt-5 pb-5">
              {singleParticipateValues?.data?.event_detail?.event_name} Details (Select Event)
            </p>
          </div>
        </div>
        ...
        <div>
          <div className="grid grid-cols-12 gap-y-3 text-wrap my-5">
            ...
            <div className="col-span-2 xl:col-span-7 2xl:col-span-9 text-sm">
            ...
            <div className="col-span-12 sm:col-span-12 2 2xl:col-span-2 text-sm">
              <div>
                <p className="text-[18px] font-bold text-center pt-5 pb-5"> Event Attachment</p>
              </div>
            </div>
            <div className="col-span-12 sm:col-span-12 2 text-sm">
...
export default NotificationSelectEvent
