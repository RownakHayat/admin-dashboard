...
const NotificationPaymentEvent = ({ singleParticipateValues }: any) => {
        ...
        <div className="xs:col-span-12 sm:col-span-12 md:col-span-12 text-sm">
          <div>
            <p className="text-[18px] font-bold text-center pt-5 pb-5 text-wrap break-words">
              {singleParticipateValues?.data?.event_detail?.event_name} Details (Payment Event)
            </p>
          </div>
        </div>
...
export default NotificationPaymentEvent
