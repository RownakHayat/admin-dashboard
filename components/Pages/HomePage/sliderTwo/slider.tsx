    ...
    <div className="sliderContent">
       ...
       <Image
          src={
            hasError
              ...
              : `${siteConfig?.envConfig[`${process.env.APP_ENV}`]?.IMAGE_URL || ""}${imgSrc || "/assets/Image/default.png"}`
          }
          alt={event_name}
          layout="fill"
          objectFit="cover"
      ...
      <div className="grid grid-cols-12 gap-2">
          <div className="col-span-6 text-start">
            ...
            {/* <h3>Duration: {moment(end_date).diff(moment(date), 'days')+1} Day</h3> */}
...
export const ReactSpring3dCarousel = () => {
  ...
  const transformedSliderData = Array.isArray(sliderData?.data)
    ? sliderData.data.map((item: any) => ({
      ...
      readMoreLink: `/admin/single-event/${item.id}`,
    }))
    : [];
